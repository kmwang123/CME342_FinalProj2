...
TARGET := main
OBJS := main.o mesh.o Array.o ionTransportEqns.o NSEqns.o mpiWrapper.o hypreSolver.o
INCS := mesh.hpp Array.hpp ionTransportEqns.hpp NSEqns.hpp mpiWrapper.hpp hypreSolver.hpp
